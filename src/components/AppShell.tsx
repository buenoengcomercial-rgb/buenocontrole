...
import { LayoutDashboard, Truck, Package, ShoppingCart, BarChart3, Menu, X, Users, CalendarDays, DollarSign, FileText, PieChart, Shield, HardHat, Palmtree, BookOpen, GraduationCap, Stethoscope } from 'lucide-react';
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="hidden lg:flex flex-col w-60 bg-sidebar fixed inset-y-0 left-0 z-30">
        <div className="px-6 py-6">
          ...
          <p className="text-xs text-sidebar-foreground mt-0.5">Gestão Interna</p>
        </div>
        ...
        {mobileOpen && (
          <>
            ...
            >
              ...
              <nav className="px-3 space-y-4 overflow-y-auto pb-6">
