...
import { LayoutDashboard, Truck, Package, ShoppingCart, BarChart3, Menu, X, Users, CalendarDays, DollarSign, FileText, PieChart, Shield, HardHat, Palmtree, BookOpen, GraduationCap, Stethoscope, Building2, Wrench, Receipt, UserCog, ClipboardList, LogOut, FileCheck, FileSpreadsheet } from 'lucide-react';
    ...
    <div className="flex min-h-screen">
      <aside className="hidden lg:flex flex-col w-60 bg-sidebar fixed inset-y-0 left-0 z-30">
        <div className="px-6 py-6">
          <h1 className="text-lg font-semibold tracking-tight text-sidebar-accent-foreground">Bueno</h1>
      ...
      <div className="lg:hidden fixed top-0 inset-x-0 h-14 bg-sidebar flex items-center px-4 z-40">
        ...
        <span className="ml-3 text-sm font-semibold text-sidebar-accent-foreground">Bueno</span>
      </div>
